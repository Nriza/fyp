...
public class TeethAdapt extends RecyclerView.Adapter<TeethAdapt.ViewHolder> {
    ...
    public TeethAdapt(Context context, String[] programNameList, int[] images, String username, String status, String patient){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.itemteeth, parent, false);
