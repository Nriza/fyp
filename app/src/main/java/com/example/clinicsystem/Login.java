                        ...
                        if (confirm.equals(password)){
                            ...
                            checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if (snapshot.exists()){
                                        nameText.setError("The Name Already Exist");
                ...
                if(code1.equals(number.trim())){
                    ...
                    reference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            patient.setStatus("patient");

                            reference.child(username).setValue(patient);
                            reference2.child(username).setValue(patient);
            ...
            checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()){
                        ...
                        if (statusFromDB.equals("patient")){
